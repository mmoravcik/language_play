...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pronunciation'
        db.create_table(u'wordphrase_pronunciation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('wordhprase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wordphrase.WordPhrase'], null=True, blank=True)),
            ('recorded_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal(u'wordphrase', ['Pronunciation'])


    def backwards(self, orm):
        # Deleting model 'Pronunciation'
        db.delete_table(u'wordphrase_pronunciation')
